...
{
    public static Scene createScene(Main mainInstance, Album album)
    {
        ...
        btnAdd.setOnAction(e -> {
            try
            {
                if (songList.getValue().equals("Add new ...")) // Check for new vs Modify
                {
                ...
                {   //Index of the song to modify
                    album.getSongs().set(songList.getSelectionModel().getSelectedIndex(), 
                        new Song(txtSongName.getText(), 
